  ...
  return (
    ...
    >
      <div className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Error Message */}
        {error && (
          <div className="text-center py-4 px-6 bg-red-100/90 backdrop-blur-sm border border-red-400 text-red-700 rounded-lg mb-8">
            {error}
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {workers.map(worker => (
              <div 
                key={worker.id} 
                className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden hover:shadow-xl 
